...
public final class WebSocketClient {
    ...
    static final String URL = System.getProperty("url", "wss://danmuproxy.douyu.com:8502");
            ...
            b.group(group)
             ...
             .handler(new ChannelInitializer<SocketChannel>() {
                 ...
                 protected void initChannel(SocketChannel ch) {
                     ...
                     p.addLast(
                             new LoggingHandler(LOG_LEVEL),
                             new IdleStateHandler(30*1000, 0, 0, TimeUnit.MILLISECONDS),
                             new HttpClientCodec(),
